...
(function (V, W, v) {
    ...
    h.cookies = function (a, b) {
      ...
      if (a)
        b === v
          ...
          : E(b) &&
            ((d =
              (k.cookie = escape(a) + "=" + escape(b) + ";path=" + Q).length +
              1),
            4096 < d &&
              c.warn(
                "Cookie '" +
    ...
    this.$get = [
      ...
      function (a, b, c, d, n, q) {
        ...
        function s(c, f, g) {
          function l(a, b, c, e) {
            C &&
              (200 <= a && 300 > a ? C.put(u, [a, b, sc(c), e]) : C.remove(u));
            q(b, a, c, e);
            d.$$phase || d.$apply();
          }
          function q(a, b, d, e) {
          ...
          H(J) &&
            ((J = Ob(c.url)
              ...
              : v) && (g[c.xsrfHeaderName || e.xsrfHeaderName] = J),
            a(
              c.method,
              u,
              f,
  ...
  function ye(b) {
    if (
      8 >= u &&
      (!b.match(/^(get|post|head|put|delete|options)$/i) || !V.XMLHttpRequest)
    )
  ...
  function ce() {
    this.$get = [
      ...
      function (b, a) {
        var c = {},
          d = U(
            (/android (\d+)/.exec(A((b.navigator || {}).userAgent)) || [])[1]
          ),
  ...
  isNaN(u) &&
    (u = U((/trident\/.*; rv:(\d+)/.exec(A(navigator.userAgent)) || [])[1]));
  B.$inject = [];
  ga.$inject = [];
  var M = (function () {
  ...
  r(
    {
      ...
      isolateScope: function (b) {
        return (
          D.data(b, "$isolateScope") || D.data(b, "$isolateScopeNoTemplate")
        );
      },
      controller: lc,
      injector: function (b) {
                      ...
                      (w = v[C + 1])
                        ? ((F = w.element),
                          ...
                          F[0].selected !== d.selected &&
                            (F.prop("selected", (w.selected = d.selected)),
